...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITY_ARCGIS_MAP_PATH . apply_filters(
            'ModularityArcgisMap/Helper/CacheBust/RevManifestPath',
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_ARCGIS_MAP_PATH . ' and run gulp. See ' . MODULARITY_ARCGIS_MAP_PATH . 'README.md for more info.</div>';
        }
    }
}
