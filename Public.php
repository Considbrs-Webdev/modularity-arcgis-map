...
if (!function_exists('modularity_arcgis_map_render_blade_view')) {
    function modularity_arcgis_map_render_blade_view($view, $data = [], $compress = true)
    {
        ...
        $viewPath = MODULARITY_ARCGIS_MAP_MODULE_VIEW_PATH;
